...
[accounts]: ../language/accounts/index
...
[`IssueStorageCapabilityController`]: ../language/accounts/capabilities#accountstoragecapabilities-and-accountaccountcapabilities
[`PublishCapability`]: /language/accounts/capabilities#accountcapabilities
[issue]: ../language/accounts/capabilities#issuing-capabilities
[publish]: ../language/accounts/capabilities#publishing-capabilities
[resources tutorial]: ./resources
[capability controller]: ../language/accounts/capabilities#accountcapabilities
[revoke capabilities]: ../language/accounts/capabilities#revoking-capabilities
[Cadence Best Practices document]: ../design-patterns
[Anti-patterns document]: ../anti-patterns
