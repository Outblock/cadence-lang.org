...
[type system]: ../language/values-and-types/index
...
[account reference]: ../language/accounts/index
[capability]: ../language/capabilities
[fully authorized account reference]: ../anti-patterns#avoid-using-fully-authorized-account-references-as-a-function-parameter
