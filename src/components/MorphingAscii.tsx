...
export function MorphingAscii() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center p-0 m-0 cursor-grab active:cursor-grabbing group w-full h-[280px] lg:h-[700px] lg:w-[700px] lg:relative lg:-right-5 overflow-hidden lg:overflow-visible">
