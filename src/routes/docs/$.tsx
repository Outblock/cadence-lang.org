          ...
          footer: (
            <div className="px-2 pb-1">
              ...
              <div className="border-t border-fd-border pt-2 mb-2">
                <AISearchTrigger
                  className="w-full flex items-center gap-2 px-2 py-1.5 rounded-lg text-xs font-medium text-fd-muted-foreground hover:text-fd-primary hover:bg-fd-accent/50 transition-colors"
                >
                  <MessageCircleIcon className="size-3.5" />
                  Ask AI
                  <span className="ms-auto font-mono text-[10px] opacity-50">⌘/</span>
                </AISearchTrigger>
              </div>
              {/* llms links */}
              <div className="border-t border-fd-border pt-2 mb-2">
