...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CyDenale.mjs");
...
const manifest = { "3754d170b07e5384cb393a7ce01e3317e54e102cb5b75ed0780e1a678ae2d91a": {
  functionName: "serverLoader_createServerFn_handler",
  importer: () => import("./_-CzQx9J1L.mjs")
} };
...
async function loadEntries() {
  const routerEntry = await import("./router-0MOvnyX6.mjs").then((n) => n.N);
  const startEntry = await import("./start-cEFD7zK8.mjs");
