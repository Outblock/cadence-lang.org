...
import { a as NodeResponse, t as toNodeHandler } from "./_libs/srvx.mjs";
...
const _lazy_Z4u9cJ = defineLazyEventHandler(() => Promise.resolve().then(function() {
  return ssrRenderer$1;
}));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_Z4u9cJ };
  return ((_m, p) => {
